...
範本＝worked example **`docs/specs/srs/EPROZ00100/`**（v0.2：機械閘門綠、spec-reviewer 無 Blocker、In Review＝現成可照抄；00800 v0.9 已封存 `docs/archive/EPROZ00800-v0.9-superseded/` 待重產）。結構/閘門對照見 `docs/specs/srs/README.md`。
