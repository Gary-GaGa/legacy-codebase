...
| **T24 SRS re-open**（`EPROISU0922`）🟡 **partial（06-22 重開：closure 過早）** | 主體欄已逐欄折回 `TBD-0922-001`（v1.5 為主源；delimiter/CRLF/encoding、null/default、A16、A31/G7、G11/G12、C12/C13/C20/C26/A52、E21、G4/G10/H8）✅。**但驗證發現 closure 過早**：① bundle 機械閘門曾 FAIL（3 個 `epl-ppdf-*` report endpoint 未具名於 spec → 06-22 已補名修正）② re-open worksheet 欄 **`A15`、`T24_COMPANY`/`B8`/`C9`（B-1 最高風險）、segments `B`/`D`/`H1–H7`** 未覆蓋 → 已開 **`TBD-0922-007`/`TBD-0922-008`（open）**。這幾項待母資料夾 refactor-spec 逐欄坐實 + owner confirm 才算真關。 | 🟡 partial（殘 TBD-007/008）| 撥貸 domain＋RD/Codex | 06-20→06-22 | `docs/specs/srs/EPROISU0922/spec.md` `TBD-0922-001/007/008`; `decisions.md`; 驗證 06-22 |
