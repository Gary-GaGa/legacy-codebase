...
| **c0 老系統 parity 補比**（reopen 06-17）| c0 評分線 00114–00120 當初只對 i0 鏡像、**未對舊企金 c0 行為比**（0921「撥貸收斂後評估補比」）→ 撥貸已收斂、補比到期；E1/E2 係先聲、與 T1 00118 合流 | c0 各頁老系統 parity 維度定版（risk-tier 00118/00120 先）| 信用決策 domain＋RD/Codex（碼驗）| 06-17 | `decisions.md` 0921＋reopen 列＋**派工卡 `build-tasks/c0-legacy-parity-recheck.md`**（套 `process/legacy-parity-sop.md`）|
