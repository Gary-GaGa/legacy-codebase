...
| **EPROC00119 SRS in-review**（fix🟡真修·待補 PRD §8） | Open SRS @PENDING IDs: none. RP40-RP54 closed 2026-06-24. fix-card 🟡 2026-06-25 全真修（RP43 量化釘死＝End Balance 應等於 Cash&Cash Equivalent、任一期不等→阻擋 Finished + REF-D2；行級 `@3dfebcf`；TBD-010 first-row opening 補驗；db-diff disclaim）。**但 2026-06-25 再審新發現 🟡（擋蓋章）**：PRD §8 兩條 Finished 阻擋規則未承載——① 有 Balance Date 且 `DIFFERENCE != 0` 不得 Finished ② 第一年度 Total Assets 或 Total Liab Equity = 0 不得 Finished（與剛釘死的 RP43 同族；PRD 已明訂、可直接寫 R7、非 TBD）。→ dev 補 R7 兩條（BE 強制 + covers-prd PRD §8 + REF-Dn）→ 再審 0 Blocker → 蓋章。 | Owner finalization checkpoint | owner | 2026-06-25 | `docs/specs/srs/EPROC00119/spec.md` R7 |
