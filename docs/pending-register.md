...
| ~~**EPROC00115 SRS ready-for-owner-finalization**~~ ✅ 規格定版 Approved 2026-06-25 | Open SRS @PENDING IDs: none（12 finalize decisions closed 2026-06-24）。fix-card 🟡 2026-06-25 全真修（openapi 金額 `\.` regex、R5/R11/R16 補 REF-D1/D2/D3、R16 掛 R9+評 CS0181/CU0181、行級 `@f91d194`、db-diff disclaim）、axis A–F 獨立再審 0 Blocker → **owner 蓋規格定版 Approved 2026-06-25**。**殘留非阻擋 🟡（折下次 touch）**：`COMMON_MSG_LIMIT` UI-only disclaim、`legacyFunctionId` 後端分流取代註明、BR-001 blank→`COMMON_MSG_ERROR_LON` 綁 R2。 | Done（Approved 2026-06-25） | owner | 2026-06-25 | `docs/specs/srs/EPROC00115/spec.md` Status |
| ~~**EPROC00119 SRS in-review**~~ ✅ 規格定版 Approved 2026-06-25 | Open SRS @PENDING IDs: none. RP40-RP55 closed. fix-card 🟡 2026-06-25 全真修後，Round 2 補承載 PRD §8 兩條 Finished 阻擋：有 Balance Date 且 `DIFFERENCE != 0`、第一年度 Total Assets 或 Total Liab Equity = 0 均由 mutating Finished save 端點 BE 權威阻擋，落在 R7/REF-D5/DEC-RP55 並同步 openapi save error branch。`check-srs-bundle docs/specs/srs/EPROC00119` PASS；獨立 A-F spec-reviewer 再審 0 Blocker / 0 Should-fix → owner 蓋規格定版 Approved。**規劃側獨立跨模型再審 2026-06-25 二次確認**：§8 兩條真承載、BE 權威、三 Finished gate（RP43/DIFFERENCE/第一年度零）正交無衝突、無 regression。RD 註：實作時回 backend 核 `E119`(第一年度零)/`E120`(difference!=0) 訊息碼方向勿標反。實作完成 pending RD；QA axis G 暫停。 | Done（Approved 2026-06-25） | owner | 2026-06-25 | `docs/specs/srs/EPROC00119/spec.md` Status |
| ~~**EPROC00120 SRS ready-for-owner-finalization**~~ ✅ 規格定版 Approved 2026-06-25 | Open SRS @PENDING IDs: none（P-001..P-013 closed 2026-06-24）。fix-card 🟡 2026-06-25 全真修（R1/R19 本頁 `applicationName`/checkpoint 不被 P-012 誤排、P-005 採 PRD 5.3.1 人工欄、db-diff disclaim 消不對稱、R2 改引 R10、行級 `@2ae96d0`、`EPROC00120_FUNC_NAME`）、axis A–F 獨立再審 0 Blocker → **owner 蓋規格定版 Approved 2026-06-25**。**殘留非阻擋 🟡（折翻新/下次 touch）**：Traceability 殘段 grandfathered、openapi 兩 row schema 重複可維護性。 | Done（Approved 2026-06-25） | owner | 2026-06-25 | `docs/specs/srs/EPROC00120/spec.md` Status |
