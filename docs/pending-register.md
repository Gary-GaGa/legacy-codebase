...
| **0921/0922 D-axis implementation closeout blockers** | SRS blocker fixes are applied and mechanical plus N-axis A/B/C/E/F/G rechecks passed, but D-axis remains FAIL for Approved. Backend evidence still lacks the 0921 duplicate-Finished guard before money/completion mutation, the 0922 service-level state `25`/assigned-checker/self-approval guard before T24/SFTP side effects, and sufficient masking for broad request/response logging. Do not owner-stamp Approved until backend fixes land and D-axis is re-run to PASS. | EPROISU0921/EPROISU0922 Approved-gate checkpoint | RD/SA | 2026-06-22 | `docs/specs/srs/EPROISU0921/`; `docs/specs/srs/EPROISU0922/`; `docs/decisions.md`; `backend/src/main/java/khd/svc/epro/service/individual/impl/DataInputServiceImpl.java`; `backend/src/main/java/khd/svc/epro/service/individual/impl/SummaryServiceImpl.java`; `backend/src/main/java/khd/svc/epro/aspect/LogAspect.java` |
