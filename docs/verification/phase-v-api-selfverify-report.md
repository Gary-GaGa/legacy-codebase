...
| RI-2 | 403 | 00011009201901010001 | /epl-case-query-reviseditem | - | - | row=0 options=9 | - | PASS | empty item fields and option count match | docs\verification\phase-v-api-selfverify-responses\RI-2-response.json |
