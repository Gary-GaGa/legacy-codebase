...
- **DoD 細目**：見 [`prd-to-srs`](../.claude/skills/prd-to-srs/) skill §DoD（每 REQ≥1 Rn、每 Rn 有 acceptance+強制點、每 TBD 一條 @PENDING+owner、Traceability Matrix 完整…）。〔QA covers / happy-error-edge 隨 QA 暫拔除。〕
