...
| 群 | 項 | owner |
|---|---|---|
| 🟢→🟠 撥貸 | 〔✅ A-1+conformance、✅ 批次層 AUD-10、✅ **T24 全裁照舊規格**〕**殘 owner-decision：A-4 檢核嚴格度、M6 完工日 DTO；KHR 幣別分支待坐実+domain 確認**（疑在地化未證）；T24 轉 Codex 執行 | 撥貸 domain |
