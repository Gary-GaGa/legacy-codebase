...
- 🔧 **待派（Codex，prompt 已備）**：① **T24 B-group 非幣別欄 batch-fix**（照舊，卡 `t24-bgroup-legacy-parity-fix.md`）② **get-body #3** reviseditem GET query（RP9 解鎖）③ **AUD-11** CU0160 碼驗（小）
...
- **owner 待裁**（非 Codex）：撥貸殘 A-4 檢核/M6、AUD-2/3/4/7/8、RP8/11、E1/2、BP-1~5
