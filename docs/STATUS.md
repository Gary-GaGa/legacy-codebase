...
撥貸核心(A-1)     █████████████░░░░░░░  ~65%   ✅ A-1+conformance、✅ 批次層 AUD-10、✅ T24 全裁「照舊規格」(06-16 owner)→轉執行；剩 Codex batch-fix T24 B-group + A-4檢核/M6
...
| 群 | 項 | owner |
|---|---|---|
| 🟢→🟠 撥貸 | 〔✅ A-1+conformance、✅ 批次層 AUD-10、✅ **T24 全裁照舊規格**〕**殘 owner-decision：A-4 檢核嚴格度、M6 完工日 DTO；🔴 A-5 幣別「收窄」regression（坐実完成→domain：有無 USD/KHR 以外幣別）**；T24 非幣別欄轉 Codex 執行 | 撥貸 domain |
