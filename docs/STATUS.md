...
> 更新：里程碑後刷新；最後更新 **2026-06-16**（orchestration pilot 通過）。
...
| 橫向 sweep② GET-body | 🔧 #1/#2 scorecard ✅（`751f78f`）；⏸ #3 reviseditem 待 RP9（method recon 完成：全站 280/282 POST、2 GET=#3 自己+00600→雙向證據齊交 RD/架構）|
