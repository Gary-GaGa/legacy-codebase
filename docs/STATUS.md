...
| 群 | 項 | owner |
|---|---|---|
| 🟢→🟠 撥貸 | 〔✅ A-1+conformance、✅ 批次層 AUD-10、✅ **T24 全裁照舊規格**、✅ KHR 保留〕**殘 owner-decision 僅：A-4 檢核嚴格度、M6 完工日 DTO 來源**（較小）；T24 轉 Codex 執行 | 撥貸 domain（A-4/M6）|
