...
- 🔧 **待派（Codex，prompt 在各卡裡）——建議並行（彼此獨立）**：
  ...
  - **P2** ③ **get-body #3** reviseditem GET query（卡 `get-body-contract-sweep.md`；⚠️ 應早於 harness 測 00800 init-query）④ **AUD-11** CU0160 碼驗（卡 `aud11-cu0160-page-reverify.md`；小、唯讀）
