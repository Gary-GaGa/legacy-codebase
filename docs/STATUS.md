...
> Last updated **2026-06-24**: corporate line `EPROC00110`/`EPROC00112`/`EPROC00114`/`EPROC00116`/`EPROC00117` promoted to **規格定版 Approved** after owner stamp — dev-machine axis A–F Blocker fixes + independent cross-model confirmation (all prior Blockers closed, no regression), mechanical `check-srs-bundle` PASS. 實作完成 pending RD (QA suspended 2026-06-24). SRS 規格定版 coverage now **10/67** (`EPROZ00100`, `EPROC00118`, `EPROISU0921`, `EPROISU0922`, `EPROZ00800` + these 5); 企金 parity 補比 (pending-register row 26) remains a separate track.
...
## 一、總進度（一句話）
**Migration code is still roughly ~80% present; FE rebuild is closed; no red owner-decision blocker is on the mainline. PRD-to-SRS 規格定版 coverage is 10/67 Approved (`EPROZ00100`, `EPROC00118`, `EPROISU0921`, `EPROISU0922`, `EPROZ00800` + corporate `EPROC00110/00112/00114/00116/00117`); 實作完成 pending RD (QA suspended). Current focus: Phase V runtime verification plus SRS expansion by risk tier.**

```
程式遷移(碼在)   ████████████████░░░░  ~80%   133/166 audit 列（源 feature-inventory §1）
PRD-to-SRS specs    ████░░░░░░░░░░░░░░░░  ~22%   **10/67 規格定版 Approved** (5 z0/撥貸 + 企金 `00110/00112/00114/00116/00117`); 4 in-review (`00115/00119/00120/SU0170`); next risk-tier pages pending
...
| **spec layer (PRD-to-SRS)** | New Bible/PRD -> SRS bundle | green: 4/67 bundles Approved (`EPROZ00100`, `EPROC00118`, `EPROISU0921`, `EPROISU0922`); pipeline ready for risk-tier expansion |
