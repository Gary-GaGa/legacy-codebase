...
撥貸核心(A-1)     ███████████████░░░░░  ~78%   ✅ A-1+conformance、✅ 批次層 AUD-10、✅ B-group parity fix(`3d6f446`)、✅ A-5 幣別 keep(只USD/KHR)；**06-20 T24/A-4/M6 SRS-層 re-open → 06-22 SRS 已產收口**(0922/0921 bundle、gate PASS、In Review checkpoint、未升 approved；0922 T24_COMPANY entity 對齊+FAILED_E999、0921 core 舊+law firm REF-D3/M6 REF-D4 偏新)；剩 T24 UAT + spec-reviewer/人審
...
| Phase D | 撥貸解鎖（A-1+T24+domain） | 🟡 **code 決策清**（A-1 conformance／AUD-10／B-group `3d6f446`／A-5 keep）→ **06-20 T24/A-4/M6 SRS-層 re-open → 06-22 SRS 已產收口**：0922/0921 bundle gate PASS、**In Review checkpoint（re-open items closed、未升 approved）**；0922 T24_COMPANY entity 對齊+FAILED_E999、0921 core 舊+law firm REF-D3/M6 REF-D4 偏新；剩 T24 UAT + spec-reviewer（pending 列 14/15）|
...
| 群 | 項 | owner |
|---|---|---|
| 🟡 撥貸（SRS In Review）| 〔code: ✅ A-1+conformance、✅ AUD-10、✅ B-group `3d6f446`、✅ A-5 keep（只 USD/KHR）〕**T24(0922)+A-4/M6(0921) 06-20 SRS-層 re-open → 06-22 SRS 已產收口、In Review checkpoint（re-open items closed、未升 approved，待 spec-reviewer/人審）**；見 pending 列 14/15 | 撥貸 domain |
...
## 六、進行中 / 待派（Codex）
- ✅ **撥貸主線本 session 全推進 → 決策牆清空**：A-1 換匯實作（`daae4c3`）+conformance PASS（OQ-1~5/交易碼驗 4/4）、批次層 **AUD-10 結**（6/8 FOUND + B005 inline-取代銷案）、**T24 全裁照舊規格**、**A-5 幣別 keep**（坐実：收窄非新增、owner 裁只 USD/KHR→無害）、**06-17 殘 domain code 裁照舊**（A-4 檢核/M6 完工日/B-1 `T24_COMPANY`/KHR-G·H 來源）→ code 決策清；**⚠️ 後續 06-20 T24/A-4/M6 SRS-層 re-open、06-22 SRS 已產收口至 In Review**（0922/0921 bundle gate PASS、未升 approved；見 pending 列 14/15、§三）
