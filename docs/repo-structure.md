...
- **active（依「結論未進 SSOT／仍為 open 項長期來源」留 live；2026-06-18 重盤＝19 份；上次校 2026-06-16＝11 份漏記後續增量）**：
  ...
  5. **PRD→SRS pipeline（live，2026-06-18 起）**：`prd-to-srs-codex-dispatch.md`（per-page worker）、`prd-to-srs-orchestrator-pilot.md`（orchestrator 迴圈）、`EPROZ00100-EPROC00118-nfix-card.md`（**進行中**：N 軸 Blocker 母資料夾修正派工）。
