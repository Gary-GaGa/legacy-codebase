...
- **live**（還要用）：`00800-verification-findings.md`（SRS as-is 來源）、`00800-rimat-fix.md`（step 2 修復包）、`00800-pending-recon.md`/`00300-return-recon.md`/`c0-authz-sql.md`（待派工：取證×2 + 授權列 SQL 預產）、`full-refactor-audit.md`（全量 zero-based 盤點，多 session→`refactor-audit/`）、`a1-funcGetExchangeRate-spec.md`、`phase-d-a1-exchange-stub-investigation.md`。
