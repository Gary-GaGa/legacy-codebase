...
| **C 規劃 / 狀態 SSOT**（橫向參考） | 盤點、對應、決策、驗證交接 | `feature-inventory.md` ⭐、`page-mapping.md`、`decisions.md`、`verification-*.md` … |

## 1. 對到 AI flow 各段（核心對照）

| flow 階段 | 角色做什麼 | 工具（Claude ∥ Codex） | 產物 / 檔案 | 閘門 |
|---|---|---|---|---|
| **Legacy → Bible**（反推·知識萃取） | EPRO Expert 反推舊系統 | **`.claude/skills/legacy-to-bible/`** ∥ `docs/env/codex/prompts/legacy-to-bible.md` | 產 `specs/bible/bible-<domain>.md`；原料＝`module-*.md`、`page-mapping.md`、`db-schema-catalog.md`、`decisions.md §D1` | — |
...
| `vision-pipeline.md` | flow 願景與原則 |
| `module-{is-iu,cs-cu}-shell.md`、`module-i0-c0-scoring.md` | 舊系統 shell / 評分結構分析 |
...
- **live**（還要用）：`00800-verification-findings.md`（SRS as-is 來源）、`a1-funcGetExchangeRate-spec.md`、`phase-d-a1-exchange-stub-investigation.md`。
