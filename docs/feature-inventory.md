...
| EPROC00117 | Financial Evaluation GI | 🔴 | ✅ | **business-only**（決策 B）：接 `epl-sele-c0-financial-list`、`epl-info/save-c0-financial-business`；**不接 `-financial-staff`**（cleanup）。prompt＝`build-tasks/phase-f-step3-00117-financial-evaluation-gi.md`；授權列 |
