...
| 🟡 T24 B-group parity（06-17） | **修正已套用，待 pre-push 人審/端到端驗證** | B-2、B-3 非幣別欄、B-4、B-5 已照舊；`E21`、`G4`/`G10`/`H8` 依 A-5 USD+KHR-only 邊界 keep。findings：`build-tasks/t24-bgroup-legacy-parity-fix-findings.md` |
