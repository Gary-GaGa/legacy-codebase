...
> 🔄 **碼驗部分回（2026-06-16）→ findings `aud10-batch-layer-reverify-findings.md`**：B006/B007 FOUND（撥貸下游不缺）、B005 匯率排程 app 碼缺（待 domain 判）、B008→ops、B001–B004 待完整 findings。**未結**（B005 判定 + B001-4 補完後收）。
