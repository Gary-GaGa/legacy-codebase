...
## 🛠 任務單 `build-tasks/`
- **進行中（live）**：
  - `phase-f-step3-00120-financial-evaluation-fi.md`（c0 FE 收尾**最後 1 頁**，business-only，決策 B；`00117` 已完成 `b14ae05`）
...
- **`build-tasks/done/`**（已消化的任務 spec / 一次性調查——歷史記錄）：
  - c0 FE 逐頁 prompt：`phase-f-step2-00114/00116/00118/00119`、`phase-f-step2-c0-scoring-fe`、`phase-f-step3-00117-financial-evaluation-gi`
