...
CREATE TABLE TB_API_AUTH (
  ...
  -- Runtime uses one API_ID row with ROLE as a semicolon-delimited allow-list.
  -- DB precheck evidence names the physical constraint TB_API_AUTH_PK(API_ID).
