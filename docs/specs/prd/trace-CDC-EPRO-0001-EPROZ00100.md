...
> 來源：Bible [`../bible/bible-eproposal.md`](../bible/bible-eproposal.md)（BR 表 + 待驗測指標 + 業務里程碑）、PRD 快照 [`PRD-CDC-EPRO-0001-EPROZ00100-v1.0.md`](PRD-CDC-EPRO-0001-EPROZ00100-v1.0.md)、缺口登記 [`../../pending-register.md`](../../pending-register.md)。本頁 status＝**In Review**（同 bundle），@PENDING 引用 bundle 內 `PENDING-Z0nn`/`TBD-0nn`。
