...
|---|---|---|---|---|
| `CDC-EPRO-0001` | — | `EPROZ00100` / `EPROC00118` | 🗑 **全清重跑（2026-06-18）**：00118 快照+SRS+trace 全砍待重放；**00100 SRS+trace 砍、PRD 留作 regen input**（prd-ready），待母資料夾用最終 pipeline 重產 | TO DO LIST / Corporate Scorecard；見 `decisions` 全清重跑列 + 留-PRD 修正列 |
